 ...
 */
public class MostrTable1 extends JFrame{
    ...
    public MostrTable1(BaseDatos BD) {
        super("");
        this.BD = BD;
        try{
        ...
        //
            ...
            if(row < modelo.getRowCount()){
                if(modelo.getValueAt(row, column) != null){
                    lbl.setText(modelo.getValueAt(row, column).toString());
                }
            }
    ...
    private void printTable(){
        ...
        for(int i = 0; i < BD.getBD().size(); ++i ){
                ...
                if(r.isVisible1()){
                    ...
                    modelo.setValueAt(r.isVisible1(),i-rem,29);
